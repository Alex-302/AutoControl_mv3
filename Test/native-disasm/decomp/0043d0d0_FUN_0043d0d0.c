// FUN_0043d0d0 @ 0043d0d0 size=231 callers=3

undefined4 * __thiscall FUN_0043d0d0(void *this,undefined4 *param_1,int *param_2,int *param_3)

{
  ...
  while (ExceptionList = ppvVar4, piVar3 != param_3) {
    ...
    FUN_0043f240(this,&local_14,piVar3);
