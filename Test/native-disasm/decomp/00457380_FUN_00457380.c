// FUN_00457380 @ 00457380 size=504 callers=1

void __thiscall FUN_00457380(void *this,uint *param_1,uint *param_2)

{
  ...
  local_30 = this;
  FUN_00457920((uint *)local_4c,param_1,param_2);
  local_14 = 0;
  local_28 = 0;
  do {
...
LAB_00457477:
      ...
      while (uVar3 = uVar8 - 4, 3 < uVar8) {
        if ((uint ***)*puVar5 != *ppppuVar6) goto LAB_0045743a;
        puVar5 = puVar5 + 1;
    ...
    if (0xf < local_50) {
      ...
      if ((0xfff < local_50 + 1) &&
         ((((((uint)local_64[0] & 0x1f) != 0 ||
          ...
          (0x23 < (uint)((int)local_64[0] - (int)_Memory))))) goto LAB_00457531;
