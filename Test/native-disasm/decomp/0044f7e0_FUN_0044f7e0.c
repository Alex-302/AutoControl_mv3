// FUN_0044f7e0 @ 0044f7e0 size=392 callers=2

void __thiscall FUN_0044f7e0(void *this,int *param_1,byte *param_2,int *param_3)
    ...
    do {
      ...
      if (*(int *)param_2 == *(int *)(iVar7 + 8)) {
        ...
        *(int *)((int)this + 8) = *(int *)((int)this + 8) + -1;
        piVar6 = (int *)param_3[0xd];
        if (piVar6 != (int *)0x0) {
          (**(code **)(*piVar6 + 0x10))(piVar6 != param_3 + 4);
          param_3[0xd] = 0;
        }
