// __trandisp2 @ 0046f827 size=140 callers=2
...

{
  ...
  *(ushort *)(unaff_EBP + -0xa0) =
  ...
  cVar2 = (char)(*(char *)(unaff_EBP + -0x9f) << 1) >> 1;
                    /* WARNING: Could not recover jumptable at 0x0046f8b1. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(param_2 + (char)((&DAT_00486c0e)[(byte)(cVar2 << 1 | cVar2 < '\0') & 0xf] |
                               (&DAT_00486c0e)[(byte)((bVar3 & 7) << 1 | (char)bVar3 < '\0')] << 2)
              + 0x10))();
  return;
}
