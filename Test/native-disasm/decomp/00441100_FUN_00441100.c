// FUN_00441100 @ 00441100 size=194 callers=33

char __thiscall FUN_00441100(void *this,undefined4 *param_1)

{
  ...
  if (*(char *)this == '\x01') {
    ...
    if (*(char *)this == '\x01') {
      puVar1 = (undefined4 *)FUN_00432d50(*(void **)((int)this + 8),&local_34,(byte *)local_20);
      local_2c = *puVar1;
    }
    if (0xf < local_c) {
