// FUN_00447060 @ 00447060 size=374 callers=3

void __thiscall FUN_00447060(void *this,int *param_1,byte *param_2,int *param_3)
    ...
    do {
      ...
      if (*(int *)param_2 == *(int *)(iVar7 + 8)) {
        ...
        *(int *)((int)this + 8) = *(int *)((int)this + 8) + -1;
        if ((undefined4 *)param_3[3] != (undefined4 *)0x0) {
          (*(code *)**(undefined4 **)param_3[3])(1);
        }
