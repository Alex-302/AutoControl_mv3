// FUN_00442e70 @ 00442e70 size=204 callers=5

undefined2 __fastcall FUN_00442e70(int *param_1,int param_2)

{
  ...
  iVar1 = *param_1;
  if ((uint)(param_1[1] - iVar1) < param_2 + 3U) {
    ExceptionList = &local_10;
    puVar2 = (uint *)FUN_00403360(local_3c,2);
    local_8 = 0;
  ...
  local_18._0_2_ =
       CONCAT11(*(undefined1 *)(iVar1 + 1 + param_2),*(undefined1 *)(iVar1 + 2 + param_2));
  return (undefined2)local_18;
}
