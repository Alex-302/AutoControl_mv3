// FUN_00455c00 @ 00455c00 size=309 callers=1

void __fastcall FUN_00455c00(int *param_1)
...
LAB_00455d2e:
        ...
        if (*(byte *)(param_1 + 0x11) < bVar3) goto LAB_00455d2e;
