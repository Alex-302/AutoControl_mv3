// FUN_00424790 @ 00424790 size=605 callers=1

void __cdecl FUN_00424790(undefined1 *param_1,void *param_2)

{
  ...
  while (cVar4 == '\0') {
    ...
    local_8 = 1;
    pcVar6 = (char *)FUN_00440e70(param_2,(uint *)&DAT_0048d830);
    FUN_00453810(pcVar6,&local_18);
    FUN_004536b0(local_4c,(uint *)local_20);
    SendMessageA(local_20[0],0x112,local_18,0);
    local_8 = 0xffffffff;
