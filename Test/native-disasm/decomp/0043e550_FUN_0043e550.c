// FUN_0043e550 @ 0043e550 size=141 callers=10

void __fastcall FUN_0043e550(int *param_1)

{
  ...
  *(int *)(*param_1 + 4) = *param_1;
  ...
  if (_Memory_00 != (int *)*param_1) {
    do {
      puVar3 = (uint *)(_Memory_00 + 2);
      piVar1 = (int *)*_Memory_00;
      if (0xf < (uint)_Memory_00[7]) {
        pvVar2 = (void *)*puVar3;
        _Memory = pvVar2;
        if ((0xfff < _Memory_00[7] + 1U) &&
           ((((((uint)pvVar2 & 0x1f) != 0 ||
