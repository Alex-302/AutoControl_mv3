// FUN_00451730 @ 00451730 size=178 callers=1

uint __fastcall FUN_00451730(int *param_1)

{
  ...
  if (((param_1[0x14] & 0x20U) == 0) || (param_1[0x13] != 0x3f)) {
    if ((param_1[0x10] & 0x200U) == 0) {
      uVar4 = FUN_00453dd0((int)param_1);
      param_1[4] = param_1[4] + -1;
    ...
    if (iVar1 != 0x3a) {
      if (iVar1 == 0x21) {
        uVar2 = FUN_00453e20(param_1,'\x01');
        param_1[4] = param_1[4] + -1;
        return uVar2 & 0xffffff00;
      }
      if (iVar1 == 0x3d) {
        uVar2 = FUN_00453e20(param_1,'\0');
        param_1[4] = param_1[4] + -1;
        return uVar2 & 0xffffff00;
      }
                    /* WARNING: Subroutine does not return */
