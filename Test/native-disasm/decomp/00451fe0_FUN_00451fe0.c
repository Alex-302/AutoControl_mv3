// FUN_00451fe0 @ 00451fe0 size=164 callers=1

uint __fastcall FUN_00451fe0(int param_1)
  ...
  if (*(uint *)(param_1 + 0x68) != 0) {
    do {
      ...
      if (((*in_EAX & uVar4) != 0) &&
        ...
        piVar1 = (int *)(*(int *)(param_1 + 0x34) + uVar5 * 8);
        piVar2 = (int *)(*(int *)(param_1 + 0x14) + uVar5 * 8);
        if (*piVar1 != *piVar2) {
        ...
        in_EAX = (uint *)piVar1[1];
        if (in_EAX != (uint *)piVar2[1]) {
