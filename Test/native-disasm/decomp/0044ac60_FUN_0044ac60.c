// FUN_0044ac60 @ 0044ac60 size=400 callers=1

void __thiscall
FUN_0044ac60(void *this,undefined4 *param_1,char param_2,undefined4 *param_3,undefined4 *param_4)

{
  ...
  piVar3 = FUN_00453140(this,param_4);
  *(int *)((int)this + 4) = *(int *)((int)this + 4) + 1;
  ...
  if (param_3 == *(undefined4 **)this) {
    ...
    **(undefined4 **)this = piVar3;
    ...
    param_3[2] = piVar3;
    iVar4 = *(int *)this;
    if (param_3 != *(undefined4 **)(iVar4 + 8)) goto LAB_0044acb8;
  }
  *(int **)(iVar4 + 8) = piVar3;
LAB_0044acb8:
  ...
  do {
    ...
    if (piVar6 == piVar5) {
      ...
      if ((char)piVar5[3] == '\0') goto LAB_0044ad4d;
