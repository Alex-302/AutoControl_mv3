// FUN_00447ae0 @ 00447ae0 size=157 callers=1

void __thiscall FUN_00447ae0(void *this,undefined4 *param_1,byte *param_2)
...
LAB_00447b6b:
    ...
    else if (-1 < (int)uVar4) goto LAB_00447b6b;
  }
  param_2 = pbVar2;
  piVar5 = FUN_0044fd20(this,uVar7,&param_2);
