// Patch AutoCtrl_2025.4.22.0.exe v10 — ISOLATION test.
// v5b (in-place `mov al,1` at 0x4155ac) WORKED ("everywhere"). v9 (jmp into
// .acp stub with role checks) did NOT. This build isolates the variable:
// same jmp into .acp, but the stub ALWAYS returns 1 (no role checks).
//   - if v10 works like v5b  -> jmp/.acp is fine, v9 failed on ROLE VALUES
//   - if v10 does NOT work   -> the .acp jmp itself is broken
//
// Changes:
//   1) 0x415781: jz fail -> 6x NOP                       [gate bypass]
//   2) 0x4155ac: `83 7e 2c 25 75 08` -> `e9 rel32; 90`   [jmp to stub]
//   3) .acp stub: pushad; popad; mov al,1; jmp 0x4155b2  [always return 1]
'use strict';
const fs = require('fs');
