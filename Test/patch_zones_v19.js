...
//
// Usage: node Test/patch_zones_v19.js [out.exe]
'use strict';
const fs = require('fs');
const path = require('path');

const SRC = path.join(process.env.LOCALAPPDATA, 'AutoControl', 'AutoCtrl_2025.4.22.0.exe.orig-pristine');
const OUT = process.argv[2] || path.join(process.env.TEMP, 'ac_native_re', 'AutoCtrl_2025.4.22.0.exe');
...
const PRISTINE_SHA256 = '8AE9A669086BEA5C4344007AC4CA9797E5814285E03B6B04E5F8336329CB7E09';
{
  ...
  if (buf.length !== 695296 || sha !== PRISTINE_SHA256) {
    ...
    console.error('Restore the pristine copy (AutoControl_native\\AutoCtrl_2025.4.22.0.exe)' +
...
// build with `node Test/patch_zones_v19.js` (no v16) unless there is a reason.
const WITH_V16 = process.argv.includes('v16');
const V16 = [
