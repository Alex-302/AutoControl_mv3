...
const _8r=a=>a,_Yk=_Nh(window[_Zh[2]]),_Tj=_Yk.runtime.id,_Bj={alias:_Yk.runtime.getManifest().short_name},_fs="AutoCtrl_*.exe",_xd=_fs.replace("*","2025.4.22.0"),_ne="AutoControlZero.exe",_Xh="file76.dat",_7i="file69.dat",_or="Native-Component.exe",_ak="main.html",_mo="www.autocontrol.app",_9n="alex-302.github.io",_Zo=`http${"s"}://${_mo}/`,_Zl=`https://${_9n}/AutoControl_mv3/https@${_mo}/`,_4a={chromeWS:"https://chromewebstore.google.com/detail/",support:"https://groups.google.com/g/autocontrol_app"},_Ge=["normal","popup","devtools","panel","app"],
