...
;
/* ===== file91.js ===== */
'use strict';var _Uy=(t=>null==t?null:{filePath:t})(_yi().file);let _Ho=!0;
...
const _8r=a=>a,_Yk=_Nh(window[_Zh[2]]),_Tj=_Yk.runtime.id,_Bj={alias:_Yk.runtime.getManifest().short_name},_fs="AutoCtrl_*.exe",_xd=_fs.replace("*","2025.4.22.0"),_ne="AutoControlZero.exe",_Xh="file76.dat",_7i="file69.dat",_or="Native-Component.exe",_ak="main.html",_mo="www.autocontrol.app",_Zo=`http${"s"}://${_mo}/`,_4a={chromeWS:"https://chromewebstore.google.com/detail/",support:"https://groups.google.com/g/autocontrol_app"},_Ge=["normal","popup","devtools","panel","app"],
...
let _xg=_we(function*(a,b="",c=!1,d="",f=!0){a=(a.match(/\b[a-z]:[^:<>|*?"]+/i)||a.match(/\\\\[a-z][^:<>|*?"]+/i)||a.match(/[^:<>|*?"]+/i)||[""])[0].replace(/\//g,"\\").replace(/(?!^)\\{2,}/g,"\\");"DIR"!=b&&(b=b.replace(/\s*[:,]\s*/g,"\x00")+"\x00");for(var e=!1,g=0;2>g&&!1===e;++g)e=yield _9j._Vy(_e,{path:a,filter:b,dfltExt:d,modal:f,saveAs:c}),a="";return e});const _Cu="chrome://favicon/";function _ig(a){return _Cu+(a.startsWith("data")||a.startsWith("javascript")?"":a)}
...
function _rl(a,f){let b=new _wk;for(let d of _qd(a))0<d&&_Yk.tabs.discard&&_Yk.tabs.discard(d,b.onReady());b.setCallback(()=>f(a))}function _yy(a,f){_Mh([],f,{url:_qd(a).filter(b=>0<b).map(b=>_zh(_Yp[b])),tabPos:"newWin",incognito:!0})}function _Rh(a,f,b){let d=new _wk;for(let c of _qd(a))0<c&&_Yk.tabs.update(c,{muted:b.mode==_fa?!_Yp[c].mutedInfo.muted:!!b.mode},d.onReady());d.setCallback(()=>f(a))}
function _9f(a,f,b){let d=new _wk;for(let c of _qd(a))0<c&&_Yk.tabs.update(c,{[b.propName]:b.mode==_fa?!_Yp[c][b.propName]:!!b.mode},d.onReady());d.setCallback(()=>f(a))}function _Pe(a,f,b){_9f(a,f,{}.add(b,{propName:"pinned"}))}
function _7f(a,f,b){let d={true:[],false:[]};if(b.inclActTab){var c=_qd(a);for(var e of _yl(c)){let h=_cd[e].activeTab.id;0>c.indexOf(h)&&a.push([h])}}for(var g of _qd(a))c=_Yp[g],0>g||!c||(e=b.mode==_fa?!_go(c):!!b.mode,d[e][c.active?"push":"unshift"](g),e&&c.active&&_Yk.tabs.update(g,{highlighted:!1}));b=new _wk;g={};for(let h of d[!0])c=_Yp[h].windowId,c in g||(g[c]=_cd[c].tabs.some(k=>_go(k))),_Yk.tabs.update(h,{highlighted:!0,active:!g[c]},b.onReady()),g[c]=!0;for(let h of d[!1])_Yk.tabs.update(h,
{highlighted:!1},b.onReady());b.setCallback(()=>f(a))}function _my(a,f,b){let d={},c=[];a[0]&&!_Jw(a[0])&&(a=[a]);for(let e of a){a=[];for(let g of e)f&&d[g]||b&&!b(g)||(d[g]=!0,a.push(g));a.length&&c.push(a)}return c}
...
(d=_ig(_zh(_Yp[c])),delete _7o[d],_Zs(d)(_ay));e==_Fd&&_rr&&_Lk(_Ww,{tabId:c});e==_Fd&&(new URL(_zh(_Yp[c]))).hostname==_mo&&_Zr(c)})}
function _Zr(a){_wj(a,{code:`(${(function(b){let c=d=>d&&chrome.runtime.sendMessage({[d.value]:decodeURI(d.closest("a").href)});window._ACtlExt||addEventListener("webSettgs",d=>c(d.target));window._ACtlExt=document.querySelector("ACtlExt")||document.head.appendChild(document.createElement("ACtlExt"));window._ACtlExt.setAttribute("ver",b);c(document.querySelector("a [value=redirSttgs]"))})})(${JSON.stringify("2025.4.22")})`})()}
